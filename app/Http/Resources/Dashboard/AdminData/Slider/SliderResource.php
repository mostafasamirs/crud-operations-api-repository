...
namespace App\Http\Resources\Dashboard\AdminData\Slider;
...
class SliderResource extends JsonResource
{
    ...
    public function toArray(Request $request)
    {
        ...
        $data = [
            ...
            'website_image' => showFile($this->resource, 'website_image'),
            'mobile_image' => showFile($this->resource, 'mobile_image'),
