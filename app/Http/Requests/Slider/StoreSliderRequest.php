...
class StoreSliderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mobile_link' => 'nullable',
            'is_active' => 'required|boolean',
            'slug' => 'required|max:100|unique:sliders,slug,',
            'website_image' => 'required|file|mimes:jpeg,png,jpg|max:2048',
            'mobile_image' => 'required|file|mimes:jpeg,png,jpg|max:2048',
            ...
            'translations.*.meta_tags' => 'nullable|max:255',
        ];
    }
    /**
