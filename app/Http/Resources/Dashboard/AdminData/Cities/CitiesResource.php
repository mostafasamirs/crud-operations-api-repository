...
namespace App\Http\Resources\Dashboard\AdminData\Cities;
...
class CitiesResource extends JsonResource
{
    ...
    public function toArray(Request $request)
    {
        ...
        $data = [
            'id' => $this->id,
            'uuid' => $this->uuid,
            'country' => $this?->country?->translations->where('locale', $request->header('lang'))->select(['name', 'default_currency', 'nationality'])->first(),
